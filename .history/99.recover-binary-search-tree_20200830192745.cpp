...
public:
    void recoverTree(TreeNode* root) {
        ...
        helper(root, swapNode1, swapNode2);
    ...
    void helper(TreeNode* root, TreeNode* swapNode1, TreeNode* swapNode2){
        if (root != NULL)
        {
            helper(root->left, swapNode1, swapNode2);
            if (swapNode1->left != NULL && swapNode1->left == NULL)
            {
            ...
            else if (swapNode2->left == NULL)
            {
                swapNode2->left = root;
            }
            else if (swapNode2->left != NULL && swapNode2->left == NULL)
            {
            ...
            helper(root->right, swapNode1, swapNode2);
        }
    }
};
// @lc code=end
