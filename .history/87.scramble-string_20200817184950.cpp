    ...
    bool isScramble(string s1, string s2) {
        ...
        else
        {
            ...
            while (step>0)
            {
                ...
                if ((isScramble(s2.substr(0,step), s1.substr(s2.size()-step,step))&&isScramble(s2.substr(step,s1.size()-step), s1.substr(0,s2.size()-step))) ||(isScramble(s2.substr(0,step), s1.substr(0,step))&&isScramble(s2.substr(step,s1.size()-step), s1.substr(step,s2.size()-step))))
                {
                    return true;
                }
                step--;
