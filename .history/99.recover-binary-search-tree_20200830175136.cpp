...
public:
    ...
    bool firstError = true;
    TreeNode* temswap = new TreeNode();
    void createTree(TreeNode* root, long lastval){
        if (root == NULL)
        {
            return;
        }
        ...
        modifyRightTree(root, lastval);
        createTree(root->left);
        createTree(root->right);
    }
    void modifyRightTree(TreeNode* root, long lastval){
